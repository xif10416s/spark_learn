...
public class TransportRequestHandler extends MessageHandler<RequestMessage> {
    ...
    public void handle(RequestMessage request) {
        logger.trace("TransportRequestHandler on handler ............");
    ...
    private void processRpcRequest(final RpcRequest req) {
        logger.trace("TransportRequestHandler processRpcRequest ............. ");
        try {
            rpcHandler.receive(reverseClient, req.body().nioByteBuffer(), new RpcResponseCallback() {

                public void onSuccess(ByteBuffer response) {
                    logger.trace("Request  RpcResponseCallback call back onSuccess ");
    ...
    private ChannelFuture respond(Encodable result) {
        ...
        return channel.writeAndFlush(result).addListener(future -> {
            if (future.isSuccess()) {
                logger.trace("Sent result {} to client {} success", result, remoteAddress);
            } else {
